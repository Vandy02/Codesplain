        ...
        <div className="w-full max-w-4xl bg-white p-6 rounded-md">
            <form action={formAction}>
                ...
                <button type="button" onClick={() => {
                    ...
                    className="flex-1 py-3 px-4 bg-transparent border-2 border-gray-300 dark:border-gray-600 text-gray-600 dark:text-gray-300 rounded-xl font-medium hover:bg-gray-100 dark:hover:bg-gray-800 hover:scale-[1.02] transition-all">
                    🧹 Clear
                </button>
                </div>
            </form>
